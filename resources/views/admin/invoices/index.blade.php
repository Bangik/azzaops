...
<div class="filter-bar">
    <form action="{{ route('admin.invoices.index') }}" method="GET" class="row g-2 align-items-end">
        <div class="col-md-5">
            ...
            <input type="text" name="q" class="form-control form-control-sm" value="{{ request('q') }}" placeholder="No. invoice atau nama customer">
        </div>
        <div class="col-md-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.invoices.show', $invoice) }}" class="btn btn-sm btn-info text-white btn-action"><i class="bi bi-eye"></i></a>
                                <a href="{{ route('admin.invoices.pdf', $invoice) }}" class="btn btn-sm btn-danger btn-action" title="Download PDF"><i class="bi bi-file-pdf"></i></a>
                            </div>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="7">
                            <div class="empty-state">
                                ...
                                <p class="small text-muted">Generate invoice dari detail work order yang sudah dilaporkan.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
