    ...
    <div class="card-body">
        <form action="{{ route('admin.customers.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3 d-none" id="company_name_container">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('pic_name') is-invalid @enderror" id="pic_name" name="pic_name" value="{{ old('pic_name') }}">
                    @error('pic_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('phone_alt') is-invalid @enderror" id="phone_alt" name="phone_alt" value="{{ old('phone_alt') }}">
                    @error('phone_alt')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('market') is-invalid @enderror" id="market" name="market" value="{{ old('market') }}" placeholder="Contoh: Retail, Hotel, Mall">
                    @error('market')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
