...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.incomes.update', $financialTransaction) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('category_id') is-invalid @enderror" id="category_id"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @selected(old('category_id', $financialTransaction->category_id) == $category->id)>{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('category_id')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('transaction_date', $financialTransaction->transaction_date->format('Y-m-d')) }}"
                            required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('financial_account_id') is-invalid @enderror"
                            ...
                            @foreach ($financialAccounts as $account)
                                <option value="{{ $account->id }}" @selected(old('financial_account_id', $financialTransaction->financial_account_id) == $account->id)>{{ $account->name }}
                                    ({{ $account->code }})</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control @error('description') is-invalid @enderror"
                            ...
                            value="{{ old('description', $financialTransaction->description) }}" required>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount"
                            name="amount" value="{{ old('amount', intval($financialTransaction->amount)) }}"
                            min="1" required>
                        @error('amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('reference_number') is-invalid @enderror"
                            ...
                            value="{{ old('reference_number', $financialTransaction->reference_number) }}">
