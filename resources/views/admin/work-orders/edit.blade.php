        ...
        <form action="{{ route('admin.work-orders.update', $workOrder) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="time" class="form-control @error('scheduled_time') is-invalid @enderror" id="scheduled_time" name="scheduled_time" value="{{ old('scheduled_time', $workOrder->scheduled_time ? date('H:i', strtotime($workOrder->scheduled_time)) : '') }}">
